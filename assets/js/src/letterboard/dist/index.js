...
const calculate_missing = (phrases, dictionary) => {
    const missing = {};
...
const phraseA = document.getElementById('phrase-a');
const phraseB = document.getElementById('phrase-b');
